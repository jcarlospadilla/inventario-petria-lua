...
-- Version: 2026.05.30-rev17-module
--
-- Que hace:
...
_eqInv = _eqInv or {}
eqInv = _eqInv
eqInv.version = "2026.05.30-rev17-module"
...
function eqInv.itemHeaderParts(item)
  ...
  return "Nivel " .. nivel .. " | Peso " .. peso .. " | Pts " .. pts .. " | Tipo " .. tipo
end
...
function eqInv.printGroupedTable(results, limit)
  ...
  for _, group in ipairs(groups) do
    ...
    if #group.items > maxItems then
      eqInv.warn("Grupo " .. group.label .. ": " .. tostring(maxItems) .. "/" .. tostring(#group.items) .. ". Filtra mas, por ejemplo: eqsearch 10-14 " .. group.label)
    end
  end
...
function eqInv.help()
  ...
  echo("eqsearch formato grouped        Agrupa por Vestir/slot en bloques compactos.\n")
